...
export function GatedContactInfo({
  ...
  if (isUnlocked) {
    return (
      <div className="flex items-start gap-3 p-3 bg-emerald-50 dark:bg-emerald-950/20 rounded-md border border-emerald-100 dark:border-emerald-900 shadow-sm animate-in fade-in duration-500">
        ...
        <div>
          <p className="text-[11px] uppercase font-bold text-emerald-700/70 dark:text-emerald-400/70 tracking-wider">
            {label}
          </p>
          ...
          <div className="flex items-center gap-1 mt-0.5">
            ...
            <span className="text-[11px] text-emerald-600 font-medium">Verified access</span>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="group relative overflow-hidden bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-md p-4 transition-all hover:border-slate-300 dark:hover:border-slate-700">
      <div className="flex items-start gap-3 blur-[3px] opacity-30 select-none grayscale pointer-events-none">
        ...
        <div>
          <p className="text-[11px] uppercase font-bold tracking-wider">{label}</p>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-center bg-slate-100/10 dark:bg-black/20 backdrop-blur-[1px] transition-all group-hover:backdrop-blur-none">
        <div className="bg-white/95 dark:bg-slate-900/95 p-4 rounded-md shadow-xl border border-slate-200 dark:border-slate-800 scale-95 transition-transform group-hover:scale-100">
             <div className="flex items-center justify-center gap-2 mb-2">
               <div className="p-1 px-3 bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-400 rounded-full text-[11px] font-bold flex items-center gap-1 uppercase tracking-wide">
      ...
      {status === "PENDING" && (
        <div className="mt-2 flex items-center gap-1.5 p-1.5 px-3 bg-slate-100 dark:bg-slate-800 rounded-md text-[11px] text-slate-500 border border-slate-200 dark:border-slate-700">
