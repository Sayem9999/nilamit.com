        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sellers.map((seller, idx) => (
            ...
            >
              ...
              {seller.isTopRated && (
                <div className="absolute top-4 right-4 flex items-center gap-1 bg-amber-50 px-2.5 py-1 rounded-full border border-amber-100 text-amber-700 text-[11px] font-bold uppercase tracking-wider shadow-xs">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-6 bg-slate-50/50 p-3 rounded-md border border-gray-50">
                  <div className="text-center">
                    <p className="text-[11px] text-gray-400 font-bold uppercase tracking-tighter mb-0.5">Vetted Level</p>
                  ...
                  <div className="text-center border-l border-gray-150">
                    <p className="text-[11px] text-gray-400 font-bold uppercase tracking-tighter mb-0.5">Completed Sales</p>
                    <div className="flex items-center justify-center gap-1 text-sm font-bold text-slate-800">
