    ...
    <section className="py-20 relative overflow-hidden bg-slate-50/50 border-y border-gray-100" aria-labelledby="top-sellers-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16 space-y-4">
          ...
          <h2 id="top-sellers-heading" className="font-heading font-black text-4xl sm:text-5xl text-gray-900 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sellers.map((seller, idx) => (
            <motion.div
              ...
              className="group relative bg-white border border-gray-100 rounded-3xl p-6 hover:shadow-xl hover:shadow-primary-600/5 hover:border-primary-100 transition-all duration-300 flex flex-col justify-between"
            >
              {/* Premium Top Rated Banner Overlay */}
              {seller.isTopRated && (
                <div className="absolute top-4 right-4 flex items-center gap-1 bg-amber-50 px-2.5 py-1 rounded-full border border-amber-100 text-amber-700 text-[9px] font-black uppercase tracking-wider shadow-xs">
              ...
              <div>
                ...
                {/* Level / Sales Stats */}
                <div className="grid grid-cols-2 gap-3 mb-6 bg-slate-50/50 p-3 rounded-2xl border border-gray-50">
              ...
              <Link
                ...
                className="w-full inline-flex items-center justify-center py-3 bg-gray-50 border border-gray-100 hover:border-primary-200 hover:bg-primary-50 rounded-2xl text-xs font-bold text-gray-600 hover:text-primary-600 transition-all gap-1.5 shadow-xs"
              >
                Visit Storefront
