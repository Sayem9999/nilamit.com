    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-md p-6 max-w-sm mx-4 shadow-xl">
        ...
        <div className="flex gap-3">
          ...
          <Link
            href="/profile"
            className="flex-1 py-2.5 bg-primary-600 text-white rounded-md text-sm font-semibold text-center hover:bg-primary-700"
          >
            {t("verifyNowBtn")}
          </Link>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-md p-6 max-w-sm mx-4 shadow-xl">
        ...
        <div className="flex items-center justify-center gap-3 my-4 bg-gray-50/50 p-3 rounded-md border border-gray-100/60">
          <span className="px-3 py-1 bg-pink-50 border border-pink-100 text-pink-600 rounded-md text-[11px] font-bold tracking-wide uppercase shadow-sm">
            bKash
          </span>
          <span className="px-3 py-1 bg-orange-50 border border-orange-100 text-orange-600 rounded-md text-[11px] font-bold tracking-wide uppercase shadow-sm">
            Nagad
          </span>
          <span className="px-3 py-1 bg-purple-50 border border-purple-100 text-purple-600 rounded-md text-[11px] font-bold tracking-wide uppercase shadow-sm">
            Rocket
          </span>
        </div>
    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
        <div className="bg-white rounded-md p-6 max-w-sm mx-4 shadow-xl text-center">
          ...
          <button
            onClick={onClose}
            className="w-full py-2.5 bg-primary-600 text-white rounded-md text-sm font-semibold hover:bg-primary-700"
          >
            {t("laterBtn")}
          </button>
        </div>
      ...
      <div className="bg-white rounded-md p-6 max-w-sm mx-4 shadow-xl">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={isPending}
            className="flex-1 py-2.5 bg-primary-600 text-white rounded-md text-sm font-semibold text-center hover:bg-primary-700 disabled:opacity-50"
          >
