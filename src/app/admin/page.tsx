  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard label="Active Auctions" value={stats.activeAuctions} icon={<Package className="w-5 h-5 text-indigo-600" />} color="bg-indigo-50" />
        <StatCard label="Total Bids" value={stats.totalBids} icon={<TrendingUp className="w-5 h-5 text-green-600" />} color="bg-green-50" />
              ...
              <tbody className="divide-y divide-gray-100">
                {stats.recentUsers.map((user: any) => (
                    <tr key={user.id} className="hover:bg-gray-50/50">
                        ...
                        <td className="px-4 py-3 text-gray-600 text-center">{user.reputationScore}</td>
