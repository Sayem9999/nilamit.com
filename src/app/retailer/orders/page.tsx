          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[750px]">
              ...
              <tbody className="divide-y divide-slate-100 text-sm font-medium">
                {orders.map((order) => (
                  <tr key={order.id} className="hover:bg-slate-50/30 transition-colors border-b border-slate-100 text-slate-700">
                    ...
                    <td className="px-6 py-4 max-w-[220px]">
                      <p className="text-slate-900 font-bold truncate" title={order.auctionTitle}>
                        {order.auctionTitle}
                      </p>
                    </td>
                    <td className="px-6 py-4">
                      <p className="text-slate-900 font-bold flex items-center gap-1">
                        <User className="w-3.5 h-3.5 text-slate-400" /> {order.buyer}
                      </p>
