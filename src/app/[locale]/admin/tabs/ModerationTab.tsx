        ...
        <div className="space-y-4">
          {reports.map((report) => (
            <div
              ...
              className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex flex-col md:flex-row gap-6"
            >
              {/* Image Preview */}
              <div className="w-full md:w-48 h-32 bg-gray-100 rounded-lg overflow-hidden flex-shrink-0 relative">
                ...
                <div
                  className={`absolute top-2 left-2 px-2 py-1 rounded text-[10px] font-bold uppercase ${report.auction.status === "ACTIVE" ? "bg-green-500 text-white" : "bg-gray-800 text-white"}`}
                >
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <Link
                      ...
                      target="_blank"
                      className="font-heading font-semibold text-lg hover:underline flex items-center gap-1"
                    >
                ...
                {filter === "PENDING" && (
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() =>
                        handleSuspend(report.auction.id, report.id)
                      }
