    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white p-8 rounded-2xl border border-green-100 shadow-sm text-center">
          ...
          <p className="text-gray-500 mb-6">{t("accountCreatedDesc")}</p>
          <Link
            href="/login"
            className="block w-full bg-primary-600 text-white font-bold py-3 rounded-xl hover:bg-primary-700"
          >
            {t("goToLogin")}
          </Link>
        </div>
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">{t("joinMarketplace")}</p>
        </div>
